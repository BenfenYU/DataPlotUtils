...
collection_name = "BDC-4-02_bha_run1_correct_mud_20240805165848"
base_path = r"C:\Users\Jyu20\Downloads\test"

channel_names = [
    ('RTHydro.SPPSIM', 'Pa'),
    ('RTHydro.ATBITECDSIM', 'kg/m3'),
    ('RTHydro.HCI', 'unitless'),
    ('RTHydro.MaxHCIDepth', 'm'),
    ('RTHydro.CUTBED', 'm'),
    ('RTHydro.CUTCON', 'unitless'),
    ('RTHydro.EngineReset', 'unitless')
]

time_series_names = [
    "RTHydro.PressureProfile",
    "RTHydro.HoleCleaningProfile",
    'HydraulicsTransientSimulation'
]
